            ...
            <div class="search-container">
                ...
                <div class="search-sidebar">
                    ...
                    <form action="product.html" method="POST" name="filter_form">
                        ...
                        <div class="mb-30px">
                            <button type="submit" class="btn btn-sm btn-theme btn-dark w-100"><i
                                    class="fa fa-search fa-fw me-1 ms-n3"></i> FILTER</button>
                        </div>
                    </form>
                        ...
                        <div class="item-row">
                            ...
                            @foreach ($subcategories as $subcategorie)
                                <div class="item item-thumbnail">
                                    <a href="/productdetail/{{ $subcategorie->id }}" class="item-image">
