...
<div id="slider" class="section-container p-0 bg-dark">
    ...
    <div id="main-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active" data-paroller="true" data-paroller-factor="0.3" data-paroller-factor-sm="0.01" data-paroller-factor-xs="0.01" style="background: url({{ asset('assets/img/slider/slider-1-cover.jpg') }}) center 0 / cover no-repeat;">

                <div class="container">
                    <img src="{{ asset('assets/img/slider/'.$data->simg) }}" class="product-img right bottom fadeInRight animated" alt="" />
                </div>

                <div class="carousel-caption carousel-caption-left">
                    <div class="container">
                        <h3 class="title mb-5px fadeInLeftBig animated">{{ $data->stitle }}</h3>
                        <p class="mb-15px fadeInLeftBig animated">{{ $data->sdescription }}</p>
                        <div class="price mb-30px fadeInLeftBig animated"><small>from</small> <span>{{$data->sprize}}</span></div>
                    ...
                    <div class="item-row">
                        ...
                        @foreach($subcategories as $subcategorie)
                            <div class="item item-thumbnail">
                                ...
                                <div class="item-info">
                                    <h4 class="item-title">
                                        <a href="product_detail.html">{{$subcategorie['subcatname']}}<br /></a>
                                    </h4>
                                    {{-- <p class="item-desc">3D Touch. 12MP photos. 4K video.</p>
                                    <div class="item-price">$649.00</div>
                                    <div class="item-discount-price">$739.00</div> --}}
