                ...
                <div class="product-detail">
                        ...
                        <div class="product-thumbnail">
                            <ul class="product-thumbnail-list">
                                <li class="active"><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus.png"><img
                                            src="../assets/img/product/product-iphone-6s-plus.png" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-2.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-2.jpg" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-3.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-3.jpg" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-4.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-4.jpg" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-5.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-5.jpg" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-6.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-6.jpg" alt="" /></a>
                                </li>
                                <li><a href="#" data-click="show-main-image"
                                        data-url="../assets/img/product/product-iphone-6s-plus-7.jpg"><img
                                            src="../assets/img/product/product-iphone-6s-plus-7.jpg" alt="" /></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-info-header">
                            ...
                            <h1 class="product-title"><span class="badge bg-primary">41% OFF</span>
                        ...
                        <div class="product-social">
                            <ul>
                                <li><a href="javascript:;" class="facebook" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        data-bs-title="Facebook" data-bs-placement="top"><i
                                            class="fab fa-facebook-f"></i></a></li>
                                <li><a href="javascript:;" class="twitter" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        data-bs-title="Twitter" data-bs-placement="top"><i class="fab fa-twitter"></i></a>
                                </li>
                                <li><a href="javascript:;" class="google-plus" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-title="Google Plus" data-bs-placement="top"><i
                                            class="fab fa-google-plus-g"></i></a></li>
                                <li><a href="javascript:;" class="whatsapp" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-title="Whatsapp" data-bs-placement="top"><i
                                            class="fab fa-whatsapp"></i></a></li>
                                <li><a href="javascript:;" class="tumblr" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" data-bs-title="Tumblr" data-bs-placement="top"><i
                        ...
                        <div class="product-purchase-container">
                            ...
                            <div class="product-price">
                                <div class="price">{{ $product->productmrp }}</div>
                            </div>
                ...
                <div class="product-tab">
                    ...
                    <ul id="product-tab" class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" href="#product-desc"
                                data-bs-toggle="tab">Product Description</a></li>
                        <li class="nav-item"><a class="nav-link" href="#product-info" data-bs-toggle="tab">Additional
                                Information</a></li>
                        <li class="nav-item"><a class="nav-link" href="#product-reviews" data-bs-toggle="tab">Rating &
                                Reviews (5)</a></li>
                    </ul>
                    <!-- END #product-tab -->
                        ...
                        <div class="tab-pane fade active show" id="product-desc">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="desc">
                                    ...
                                    <p>
                                        ...
                                        memories to life in a powerfully vivid way. And that’s just the beginning. Take a
                                        deeper look at iPhone 6s, and you’ll find innovation on every level.
                                    </p>
                                </div>
                            </div>
                            <!-- END product-desc -->
                            ...
                            <div class="product-desc">
                                ...
                                <div class="desc">
                                    <h4>Cameras</h4>
                                    <p>
                                        The 12-megapixel iSight camera captures sharp, detailed photos. It takes brilliant
                                        4K video, up to four times the resolution of 1080p HD video. iPhone 6s also takes
                                        selfies worthy of a self-portrait with the new 5-megapixel FaceTime HD camera. And
                                        it introduces Live Photos, a new way to relive your favorite memories. It captures
                                        the moments just before and after your picture and sets it in motion with just the
                                        press of a finger.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="product-desc right">
                                ...
                                <div class="desc">
                                    <h4>Technology</h4>
                                    <p>
                                        iPhone 6s is powered by the custom-designed 64-bit A9 chip. It delivers performance
                                        once found only in desktop computers. You’ll experience up to 70 percent faster CPU
                                        performance, and up to 90 percent faster GPU performance for all your favorite
                                        graphics-intensive games and apps.
                                    </p>
                                </div>
                            </div>
                            <!-- END product-desc -->
                            ...
                            <div class="product-desc">
                                ...
                                <div class="desc">
                                    <h4>Design</h4>
                                    <p>
                                        Innovation isn’t always obvious to the eye, but look a little closer at iPhone 6s
                                        and you’ll find it’s been fundamentally improved. The enclosure is made from a new
                                        alloy of 7000 Series aluminum — the same grade used in the aerospace industry. The
                                        cover glass is the strongest, most durable glass used in any smartphone. And a new
                                        rose gold finish joins space gray, silver, and gold.
                                    </p>
                                </div>
                            </div>
                            <!-- END product-desc -->
                                ...
                                <div class="col-md-7 mb-4 mb-lg-0">
                                    ...
                                    <div class="review">
                                        <div class="review-info">
                                            <div class="review-icon"><img src="../assets/img/user/user-1.jpg"
                                                    alt="" /></div>
                                    ...
                                    <div class="review">
                                        <div class="review-info">
                                            <div class="review-icon"><img src="../assets/img/user/user-2.jpg"
                                                    alt="" /></div>
                                            <div class="review-rate">
                                                <ul class="review-star">
                                                    <li class="active"><i class="fa fa-star"></i></li>
                                        ...
                                        <div class="review-message">
                                            In mauris leo, maximus at pellentesque vel, pharetra vel risus. Aenean in semper
                                            velit. Pellentesque habitant morbi tristique senectus et netus et malesuada
                                            fames ac turpis egestas. Morbi volutpat mattis neque, at molestie tellus
                                            ultricies quis. Ut lobortis odio nec nunc ullamcorper, vitae faucibus augue
                                    ...
                                    <div class="review">
                                        <div class="review-info">
                                            <div class="review-icon"><img src="../assets/img/user/user-3.jpg"
                                                    alt="" /></div>
                                            <div class="review-rate">
                                                <ul class="review-star">
                                                    <li class="active"><i class="fa fa-star"></i></li>
                                        ...
                                        <div class="review-message">
                                            Duis ut nunc sem. Integer efficitur, justo sit amet feugiat hendrerit, arcu nisl
                                    ...
                                    <div class="review">
                                        <div class="review-info">
                                            <div class="review-icon"><img src="../assets/img/user/user-4.jpg"
                                                    alt="" /></div>
                                            <div class="review-rate">
                                                <ul class="review-star">
                                                    <li class="active"><i class="fa fa-star"></i></li>
                                        ...
                                        <div class="review-message">
                                            ...
                                            Vivamus tempus, turpis iaculis tempus egestas, leo augue hendrerit tellus, et
                                            efficitur neque massa at neque. Aenean efficitur eleifend orci at ornare.
                                        </div>
                                    </div>
                                    <!-- END review -->
                                    <!-- BEGIN review -->
                                    <div class="review">
                                        <div class="review-info">
                                            <div class="review-icon"><img src="../assets/img/user/user-5.jpg"
                                                    alt="" /></div>
                                            <div class="review-rate">
                                                <ul class="review-star">
                                                    <li class="active"><i class="fa fa-star"></i></li>
                                        ...
                                        <div class="review-title">
                                            I have an existing carrier contract or installment plan. Can I purchase with the
                                            iPhone Upgrade Program
                                        </div>
                                        <div class="review-message">
                                            Aliquam consequat ut turpis non interdum. Integer blandit erat nec sapien
                                            sollicitudin, a fermentum dui venenatis. Nullam consequat at enim et aliquet.
                                            Cras mattis turpis quis eros volutpat tristique vel a ligula. Proin aliquet leo
                                            mi, et euismod metus placerat sit amet.
                                        </div>
                                    </div>
                                    <!-- END review -->
                                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="review-form">
                                        <form action="product_detail.html" name="review_form" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <label for="email" class="form-label">Rating <span
                                                        class="text-danger">*</span></label>
                                            ...
                                            <button type="submit" class="btn btn-dark btn-theme btn-lg">Submit
                                                Review</button>
                                        </form>
                                    </div>
                                    <!-- END review-form -->
